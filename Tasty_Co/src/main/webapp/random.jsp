...
<body>
    ...
    <div class="hero">
        ...
        <%--  <div class="explore"> 
            <a href="Menupage.jsp"></a><button>Explore</button></a>
        </div> 
        --%>
        </div>
    </div>
...
<section>
    ...
    <div class="boxes">
        <div class="box">
            <img src="imgs\salad.jpeg" height="150px" width="150px">
            <div class="text"> 
                <p class="txt">Salad</p>
                <p class="subt">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti harum quasi id illo nam? Aspernatur dolore </p></div>
        </div>
        <div class="box">
            <div class="ig"><img src="imgs\noodles1.jpeg" height="150px"></div>
            <div class="text"> 
                <p class="txt">Noodles</p>
                <p class="subt">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti harum quasi id illo nam? Aspernatur dolore </p></div>
        </div>
        <div class="box">
            <div class="ig"><img src="imgs\salad.jpeg" height="150px"></div>
            <div class="text"> 
                <p class="txt">Salad</p>
                <p class="subt">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti harum quasi id illo nam? Aspernatur dolore </p></div>
        </div>
    ...
    <section>
        <div class="best">
            ...
            <div class="boxes">
                <div class="box1">
                    <img src="imgs/salad.jpeg" height="120px" width="120px">
                    <div class="text1"> 
                        <p class="txt">Salad</p>
                        <p class="subt">Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti harum quasi id illo nam? Aspernatur dolore </p>
                    </div>
                </div>
                <div class="box1">
                    <img src="imgs/salad.jpeg" height="120px" width="120px">
